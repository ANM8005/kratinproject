  ...
  <ul class="nav nav-tabs">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="#">Mental helath</a>
        <a class="dropdown-item" href="#">Workship</a>
        <a class="dropdown-item" href="">Meditation</a></div>
    </li>
    <li class="nav-item">
...
<p class="text-center">Anyone can practice meditation. It's simple and inexpensive, and it doesn't require any special equipment.
...
And you can practice meditation wherever you are — whether you're out for a walk, riding the bus, waiting at the doctor's office or even in the middle of a difficult business meeting.
    ...
    <div class="contanier-fluid">
      <div class = "row">
            ...
            <img src="images/cc5.jpg" class = "img-fluid  abouttimg pb-3  ">
  </div>
